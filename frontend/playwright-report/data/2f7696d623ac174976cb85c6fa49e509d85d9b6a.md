...
- Name: goals.spec.ts >> Lernziele (FR-1) >> Lernziel als Erreicht markieren
- Location: e2e\goals.spec.ts:43:7
...
- textbox "Name":
  ...
  - text: Goals Tester 1786434942342
- text: E-Mail
- textbox "E-Mail":
  - /placeholder: name@beispiel.de
  - text: goals-1786434942342@playwright.local
- text: Passwort
- textbox "Passwort":
