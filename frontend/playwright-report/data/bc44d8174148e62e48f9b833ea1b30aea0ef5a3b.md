...
- Name: timer.spec.ts >> Lernzeit-Timer (FR-4) >> Session starten — Timer läuft
- Location: e2e\timer.spec.ts:29:7
...
- textbox "Name":
  ...
  - text: Timer Tester 1786434928270
- text: E-Mail
- textbox "E-Mail":
  - /placeholder: name@beispiel.de
  - text: timer-1786434928270@playwright.local
- text: Passwort
- textbox "Passwort":
