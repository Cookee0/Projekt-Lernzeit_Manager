...
- Name: goals.spec.ts >> Lernziele (FR-1) >> Lernziel als In Arbeit markieren
- Location: e2e\goals.spec.ts:31:7
...
- textbox "Name":
  ...
  - text: Goals Tester 1786434935302
- text: E-Mail
- textbox "E-Mail":
  - /placeholder: name@beispiel.de
  - text: goals-1786434935302@playwright.local
- text: Passwort
- textbox "Passwort":
